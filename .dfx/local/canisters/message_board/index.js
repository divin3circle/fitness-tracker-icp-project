...
import { idlFactory } from './message_board.did.js';
export { idlFactory } from './message_board.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MESSAGE_BOARD_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./message_board.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the message_board canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./message_board.did.js")._SERVICE>}
 */
export const message_board = createActor(canisterId);
