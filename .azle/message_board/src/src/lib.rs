...
struct StableBTreeMap0ValueType(Exercise);
impl CdkActTryIntoVmValue<&mut boa_engine::Context<'_>, boa_engine::JsValue>
...
#[ic_cdk_macros::query(name = "getExercises")]
#[candid::candid_method(query, rename = "getExercises")]
async fn _cdk_user_defined_getExercises() -> (_AzleResult<Vec<Exercise>, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            let uuid = uuid::Uuid::new_v4().to_string();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "getExercises".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let function_js_value = exports_js_object
                .get("getExercises", &mut boa_context)
                .unwrap();
...
#[ic_cdk_macros::query(name = "getExercise")]
#[candid::candid_method(query, rename = "getExercise")]
async fn _cdk_user_defined_getExercise(
    _cdk_user_defined_id: String,
) -> (_AzleResult<Exercise, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            let uuid = uuid::Uuid::new_v4().to_string();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "getExercise".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("getExercise", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
#[ic_cdk_macros::query(name = "calculateTotalCaloriesBurned")]
#[candid::candid_method(query, rename = "calculateTotalCaloriesBurned")]
async fn _cdk_user_defined_calculateTotalCaloriesBurned() -> (_AzleResult<
    _CdkFloat64,
    String,
>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "calculateTotalCaloriesBurned".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("calculateTotalCaloriesBurned", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
#[ic_cdk_macros::update(name = "addExercise")]
#[candid::candid_method(update, rename = "addExercise")]
async fn _cdk_user_defined_addExercise(
    _cdk_user_defined_payload: ExercisePayload,
) -> (_AzleResult<Exercise, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            let mut boa_context = box_context_ref_cell.borrow_mut();
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "addExercise".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("addExercise", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
#[ic_cdk_macros::update(name = "updateExercise")]
#[candid::candid_method(update, rename = "updateExercise")]
async fn _cdk_user_defined_updateExercise(
    _cdk_user_defined_id: String,
    _cdk_user_defined_payload: ExercisePayload,
) -> (_AzleResult<Exercise, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "updateExercise".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("updateExercise", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
#[ic_cdk_macros::update(name = "deleteExercise")]
#[candid::candid_method(update, rename = "deleteExercise")]
async fn _cdk_user_defined_deleteExercise(
    _cdk_user_defined_id: String,
) -> (_AzleResult<Exercise, String>) {
    BOA_CONTEXT_REF_CELL
        .with(|box_context_ref_cell| {
            ...
            METHOD_NAME_REF_CELL
                .with(|method_name_ref_cell| {
                    let mut method_name_mut = method_name_ref_cell.borrow_mut();
                    *method_name_mut = "deleteExercise".to_string();
                });
            MANUAL_REF_CELL
                .with(|manual_ref_cell| {
                    let mut manual_mut = manual_ref_cell.borrow_mut();
            ...
            let exports_js_object = exports_js_value.as_object().unwrap();
            let function_js_value = exports_js_object
                .get("deleteExercise", &mut boa_context)
                .unwrap();
            let function_js_object = function_js_value.as_object().unwrap();
            let boa_return_value = unwrap_boa_result(
                function_js_object
...
struct Exercise {
    id: Box<String>,
    name: Box<String>,
    durationMinutes: Box<_CdkFloat64>,
    caloriesBurned: Box<_CdkFloat64>,
    date: Box<u64>,
}
#[derive(
    serde::Deserialize,
